...
city = ['Mumbai', 'Calcutta', 'Karachi', 'Delhi', 'Riyadh', 'Istanbul', 'Cairo', 'Bangkok', 'Singapore', 'Jakarta', 'Sydney', 'Guangzhou', 'Shanghai', 'Tokyo', 'Seoul', 'Beijing', 'Moscow', 'Berlin', 'Rome', 'Lagos', 'Casablanca', 'Paris', 'London', 'Buenos', 'Sao Paulo', 'Rio', 'Lima', 'Bogota', 'Mexico', 'Los', 'Chicago', 'New', 'Toronto', 'Cape', 'Durban', 'Anchorage', 'Churchill']
