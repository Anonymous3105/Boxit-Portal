...
<body>
	...
	<table>
		...
		<tr>
			<td>Address :</td>
			<td><textarea rows="5" cols="22" name="faddress" maxlength="150" required="required" ></textarea></td>
		</tr>
		<tr>
			<td>Landmark :</td>
	...
	<table>
		...
		<tr>
			<td>Address :</td>
			<td><textarea rows="5" cols="22" name="taddress" maxlength="150" required="required" ></textarea></td>
		</tr>
		<tr>
			<td>Landmark :</td>
	...
	<fieldset>
		...
		<table >
			...
			<tr>
				<td>Weight</td>
				<td><input type="text" name="weight" size="10px" required="required"  /><!--max 50kg as per FAQ--></td>
				<td>Kg</td>
				<td>Quantity</td>
